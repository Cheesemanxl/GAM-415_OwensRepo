...
#ifdef PAINTSHOOTEROWENS_PaintShooterOwensCharacter_generated_h
#error "PaintShooterOwensCharacter.generated.h already included, missing '#pragma once' in PaintShooterOwensCharacter.h"
#endif
...
public: \
	DECLARE_CLASS(APaintShooterOwensCharacter, ACharacter, COMPILED_IN_FLAGS(0), 0, TEXT("/Script/PaintShooterOwens"), NO_API) \
	DECLARE_SERIALIZER(APaintShooterOwensCharacter) \
...
#define PaintShooterOwens_Source_PaintShooterOwens_PaintShooterOwensCharacter_h_17_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, APaintShooterOwensCharacter); \
DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(APaintShooterOwensCharacter); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API APaintShooterOwensCharacter(APaintShooterOwensCharacter&&); \
	NO_API APaintShooterOwensCharacter(const APaintShooterOwensCharacter&); \
public:
...
#define PaintShooterOwens_Source_PaintShooterOwens_PaintShooterOwensCharacter_h_17_PRIVATE_PROPERTY_OFFSET \
	...
	FORCEINLINE static uint32 __PPO__VR_Gun() { return STRUCT_OFFSET(APaintShooterOwensCharacter, VR_Gun); } \
	FORCEINLINE static uint32 __PPO__VR_MuzzleLocation() { return STRUCT_OFFSET(APaintShooterOwensCharacter, VR_MuzzleLocation); } \
	FORCEINLINE static uint32 __PPO__FirstPersonCameraComponent() { return STRUCT_OFFSET(APaintShooterOwensCharacter, FirstPersonCameraComponent); } \
	FORCEINLINE static uint32 __PPO__R_MotionController() { return STRUCT_OFFSET(APaintShooterOwensCharacter, R_MotionController); } \
...
#define CURRENT_FILE_ID PaintShooterOwens_Source_PaintShooterOwens_PaintShooterOwensCharacter_h
